(function () {
    ...
    function showKidsMenu() {
        Lampa.Select.show({
            ...
            items: [
                { title: Lampa.Lang.translate('sursSelect_kids_movies'), url: 'discover/movie?&with_genres=16' },
                { title: Lampa.Lang.translate('sursSelect_kids_tvshows'), url: 'discover/tv?&with_genres=16' },
